              ...
              return (
                <div key={stage.key} className="mb-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-xs text-gray-400">{stageQuotes.length}</span>
                    <span className="text-xs text-gray-400 ml-auto">{formatCurrency(stageValue)}</span>
                  </div>
                    ...
                    {stageQuotes.map(quote => (
                      <Card key={quote.id} onClick={() => navigate(`/quotes/${quote.id}`)} className="py-3">
                        <div className="flex items-center justify-between">
                          ...
                          <p className="text-sm font-bold text-gray-900 ml-3">{formatCurrency(getQuoteTotal(quote))}</p>
                        </div>
                      </Card>
                    ))}
                  </div>

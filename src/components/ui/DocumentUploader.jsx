    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          disabled={uploading}
          className="text-xs text-pool-600 dark:text-pool-400 font-semibold hover:text-pool-700 min-h-tap flex items-center"
        >
        ...
        >
          {uploading ? (
            ...
            <>
              ...
              <span className="text-sm text-gray-400 dark:text-gray-500">Tap to upload documents</span>
            </>
          )}
        </button>
      ) : (
            ...
            <div key={doc.id} className="flex items-center gap-3 bg-gray-50 dark:bg-gray-800 rounded-xl px-3 py-2.5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  <span className="text-[10px] text-gray-400 dark:text-gray-500">{formatSize(doc.file_size)}</span>
                </div>
              </div>
              <button

...
export default function TechShell() {
  ...
  return (
    <>
      {/* Sticky header */}
      <header className="sticky top-0 z-30 bg-white/95 backdrop-blur border-b border-gray-100 shadow-nav">
        <div className="flex items-center justify-between px-4 h-14 max-w-lg mx-auto">
          ...
          {/* Business name */}
          <p className="text-xs text-gray-400 font-medium truncate max-w-[40%] text-center">
            {business?.name || ''}
          </p>
          ...
          <div className="relative">
            ...
            >
              {staffRecord?.photo_url ? (
                <img src={staffRecord.photo_url} alt={techName} className="w-8 h-8 rounded-full object-cover border border-gray-200" />
              ) : (
            ...
            {menuOpen && (
              <>
                ...
                <div className="absolute right-0 top-11 z-50 bg-white rounded-xl shadow-elevated border border-gray-100 py-1 w-44 animate-scale-in">
                  <button
